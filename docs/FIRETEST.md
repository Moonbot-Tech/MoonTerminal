...
Оба шторма — чистый и static-text — проходят через одну функцию с одними потолками. Раньше их
считали вместе, и цена 10000 меток приписывалась движению курсора.
