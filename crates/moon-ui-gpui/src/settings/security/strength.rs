...
const COMMON_CHUNKS: [&str; 34] = [
    "password", "passwort", "parol", "qwerty", "qwertz", "asdf", "zxcv", "1234", "12345", "123456",
    "admin", "root", "login", "letmein", "welcome", "master", "secret", "dragon", "monkey",
    "iloveyou", "sunshine", "princess", "football", "baseball", "trustno1", "whatever", "moonbot",
    "moonterminal", "binance", "bitcoin", "crypto", "trader", "abcabc", "test123",
];
