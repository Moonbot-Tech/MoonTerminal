...
pub fn key_slot_meta(slot: KeySlot) -> SlotMeta {
    ...
    match slot {
        ...
        // Terminal-only Live/Pause toggle: Moonbot has no hotkey for Автосдвиг, and the flag is
        // application-wide already (`Backend::follow`).
        S::ToggleLive => meta(Local, Scope::APP),
