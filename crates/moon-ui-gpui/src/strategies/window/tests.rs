...
///
/// Mutation: remove the group argument from Orders, CoinMenu, or Analytics. That caller would
/// become unscoped and could reveal its retained core after Auto navigation.
#[test]
